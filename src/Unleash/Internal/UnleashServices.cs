...
namespace Unleash
{
    internal class UnleashServices : IDisposable
    {
        ...
        public UnleashServices(UnleashSettings settings, EventCallbackConfig eventConfig, Dictionary<string, IStrategy> strategyMap)
        {
            ...
            var loader = new CachedFilesLoader(settings.JsonSerializer, settings.FileSystem, settings.ToggleBootstrapProvider, eventConfig, settings, settings.BootstrapOverride);
